package slam.com.slamzoomimagelistview.UI;
 ...
 *
 */
public class TouchPinchZoomImageView extends android.support.v7.widget.AppCompatImageView implements View.OnTouchListener {
    ...
    public TouchPinchZoomImageView(Context context) {
        this(context, null, 0);
    }

    public TouchPinchZoomImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TouchPinchZoomImageView(Context context, AttributeSet attrs, int defStyle) {
